...
lines.push("");
lines.push(
  "> Full company, course, and blog listing for AI bulk ingestion. See llms.txt for the short version.",
);
lines.push("");
lines.push("## Summary");
lines.push(
...
for (const center of centers) {
  const label = center.isHQ
    ? `${center.city}, ${center.state} (Head Office)`
...
console.log(
  `Wrote public/llms-full.txt — ${courses.length} courses, ${centers.length} centers, ${blogPosts.length} blog posts`,
);
