  ...
  useEffect(() => {
    ...
    const COURSES: Course[] = [
      ...
      },
      {
        ...
        desc: "UGC-recognized degree via Acharya Nagarjuna University, widely accepted by Gulf employers. Advanced 4-year honours degree with specialized research & internship.",
        goals: ["student", "upgrade", "gulf"],
        levels: ["12th"],
        states: "all",
      },
      {
