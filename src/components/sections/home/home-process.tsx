export default function HomeProcess() {
  return (
    <section
      id="process"
      className="w-full min-h-screen py-[200px] max-lg:py-[70px] max-md:py-[60px] max-sm:py-[80px] bg-white flex justify-center items-center flex-col overflow-x-hidden"
    >
      <div className="w-[1200px] max-w-full max-lg:w-[90%] max-sm:w-[95%] flex flex-col gap-[64px] max-sm:gap-[32px] justify-center items-center">
        <h2 className="font-sans text-[7vw] max-lg:text-[10vw] font-black leading-[100%] tracking-normal text-center break-words w-full">
          4 Steps to Your{" "}
          <span className="font-display italic">Safety Career</span>
        </h2>
        ...
        <div className="flex flex-col justify-center items-center w-full gap-[64px] max-md:gap-[48px]">
          <div className="flex flex-row max-md:flex-col-reverse justify-center items-center w-full">
            <div className="w-1/2 max-sm:w-full flex flex-col gap-[32px] max-sm:gap-[8px]">
              <div className="text-right flex flex-col gap-[16px] text-slide-left">
                <span className="font-sans text-[48px] max-md:text-[40px] max-sm:text-[28px] font-bold leading-none text-nifs-red">
                  01
                </span>
                <h3 className="font-sans font-bold text-[60px] max-md:text-[44px] max-sm:text-[32px] text-black leading-[100%]">
                  Apply
                </h3>
                <p className="text-right font-normal font-sans text-[24px] max-md:text-[15px] text-gray-500">
                  Fill out the online application or visit your nearest NIFS
                  center. Choose from 10+ programs across diploma, postgraduate,
                  and degree levels.
                </p>
              </div>
              <div className="rounded-[48px] max-md:rounded-[32px] h-[40px] bg-gray-200">
                <div className="h-full rounded-[inherit] flex justify-end">
                  <div
                    className="home-bar-fill bg-nifs-red h-full rounded-[inherit]"
                    data-width="100%"
                  />
                </div>
              </div>
          ...
          <div className="flex flex-row-reverse max-md:flex-col-reverse justify-center items-center w-full">
            <div className="w-1/2 max-sm:w-full flex flex-col gap-[32px] max-sm:gap-[8px]">
              <div className="flex flex-col gap-[16px] text-slide-right">
                <span className="font-sans text-[48px] max-md:text-[40px] max-sm:text-[28px] font-bold leading-none text-left text-emerald-700">
                  02
                </span>
                <h3 className="font-sans font-bold text-[60px] max-md:text-[44px] max-sm:text-[32px] text-black leading-[100%] text-left">
                  Assessment
                </h3>
                <p className="font-normal font-sans text-[24px] max-md:text-[15px] text-left text-gray-600">
                  Our counselors guide you through eligibility verification and
                  help select the right program based on your qualifications and
                  career goals.
                </p>
              </div>
              <div className="rounded-[48px] max-md:rounded-[32px] h-[40px] bg-gray-200">
                <div className="h-full rounded-[inherit] flex justify-start">
                  <div
                    className="home-bar-fill bg-emerald-700 h-full rounded-[inherit]"
                    data-width="75%"
                  />
                </div>
              </div>
            ...
            <div className="w-1/2 max-sm:w-full flex items-center justify-center p-8">
              <svg viewBox="0 0 200 200" className="w-[180px] h-[180px]">
                <circle cx="100" cy="100" r="80" fill="#047857" opacity="0.1" />
                <circle
                  cx="100"
                  cy="100"
                  r="50"
          ...
          <div className="flex flex-row max-md:flex-col-reverse justify-center items-center w-full">
            <div className="w-1/2 max-sm:w-full flex flex-col gap-[32px] max-sm:gap-[8px]">
              <div className="text-right flex flex-col gap-[16px] text-slide-left">
                <span className="font-sans text-[48px] max-md:text-[40px] max-sm:text-[28px] font-bold leading-none text-amber-700">
                  03
                </span>
                <h3 className="font-sans font-bold text-[60px] max-md:text-[44px] max-sm:text-[32px] text-black leading-[100%]">
                  Enroll
              ...
              <div className="rounded-[48px] max-md:rounded-[32px] h-[40px] bg-gray-200">
                <div className="h-full rounded-[inherit] flex justify-end">
                  <div
                    className="home-bar-fill bg-amber-700 h-full rounded-[inherit]"
                    data-width="50%"
                  />
                </div>
              </div>
            ...
            <div className="w-1/2 max-sm:w-full flex items-center justify-center p-8">
              <svg viewBox="0 0 200 200" className="w-[180px] h-[180px]">
                <circle cx="100" cy="100" r="80" fill="#b45309" opacity="0.1" />
                <circle
                  cx="100"
                  cy="100"
                  r="50"
          ...
          <div className="flex flex-col items-center gap-8 max-w-[700px]">
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="font-normal font-sans text-[24px] max-md:text-[15px] text-gray-500 text-center">
                Our dedicated placement cell connects you with top recruiters.
                Graduate into a career at leading industries across India and
                abroad.
              </p>
            </div>
