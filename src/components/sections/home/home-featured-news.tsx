        ...
        <div className="flex gap-12 max-lg:flex-col items-center">
          <div className="w-[52%] max-lg:w-full flex-shrink-0 relative">
            <div className="rounded-[28px] overflow-hidden shadow-[0_20px_80px_rgba(0,0,0,0.18)] relative">
              ...
              <div className="absolute bottom-5 left-5 flex items-center gap-2">
                <span className="bg-nifs-red text-white font-sans text-[11px] font-bold uppercase tracking-[2px] px-3 py-1.5 rounded-full shadow">
                  Featured News
                </span>
                <span className="bg-black/60 text-white font-sans text-[11px] font-medium px-3 py-1.5 rounded-full backdrop-blur-sm">
                  July 31, 2025
                </span>
              </div>
            </div>
            <div
              ...
              style={{
                backgroundImage:
                  "radial-gradient(circle,#cc1b1b 1.5px,transparent 1.5px)",
          ...
          <div className="flex-1 flex flex-col gap-6 max-lg:items-center max-lg:text-center w-full">
            <div className="flex items-center gap-3 max-lg:justify-center">
              ...
              <span className="font-sans text-nifs-red text-[12px] font-bold uppercase tracking-[3px]">
                Latest Update
              </span>
            </div>
            ...
            <p className="font-sans text-gray-700 text-[15px] max-sm:text-[14px] leading-[1.7] max-w-[480px]">
              In a significant development in the field of fire and safety
              education, NIFS India has achieved a landmark collaboration with
              Acharya Nagarjuna University. This partnership enables students to
              pursue advanced safety certifications backed by a recognized
              university degree — opening doors to careers across India, Gulf
              countries, and beyond.
            </p>

            <div className="flex gap-8 max-sm:gap-5 max-lg:justify-center">
              <div className="flex flex-col">
                <span className="font-sans text-gray-900 font-black text-[22px]">
                  2025
                </span>
                <span className="font-sans text-gray-600 text-[12px] uppercase tracking-widest font-semibold">
                  Year
                </span>
              </div>
