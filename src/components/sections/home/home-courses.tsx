...
const COURSES = [
  { tag: "DFS", title: "Diploma in Fire & Safety", duration: "1 Year • NSDC Approved", desc: "Fire Prevention & Emergency Response", img: "/images/courses/diploma-in-fire-safety.webp" },
  { tag: "DHSE", title: "Diploma in HSE", duration: "1 Year • NSDC Approved", desc: "Health, Safety & Environment", img: "/images/courses/diploma-in-health-safety-environment.webp" },
  { tag: "DIS", title: "Diploma in Industrial Safety", duration: "1 Year • NSDC Approved", desc: "Industrial Hygiene & Hazard Management", img: "/images/course-card-industrial-safety.webp" },
  { tag: "PGDFS", title: "PG Diploma in Fire & Safety", duration: "1 Year • NSDC Approved", desc: "Advanced Fire Engineering", img: "/images/course-card-fire-safety.webp" },
  { tag: "PGDHSE", title: "PG Diploma in HSE", duration: "1 Year • NSDC Approved", desc: "Senior HSE Management", img: "/images/corporate-training-onsite.webp" },
  { tag: "ADFS", title: "Advanced Diploma in Fire & Safety", duration: "18 Months • NSDC Approved", desc: "Fire Risk Assessment & Safety Audits", img: "/images/training-yard-drill.webp" },
  { tag: "B.Sc", title: "B.Sc in Fire & Industrial Safety", duration: "3 Years (6 Semesters) • University Approved", desc: "Full degree with internship training", img: "/images/gallery-practical-yard.webp" },
  { tag: "B.Sc Hons", title: "B.Sc (Honours) in Fire & Industrial Safety", duration: "4 Years (8 Semesters) • University Approved", desc: "4-year honours degree program", img: "/images/gallery-industrial-visit.webp" },
  { tag: "CCFS", title: "Certificate Course in Fire & Safety", duration: "3-6 Months • NSDC Approved", desc: "Quick-entry safety certification", img: "/images/courses/certificate-course-in-fire-safety.webp" },
];
...
export default function HomeCourses() {
  ...
  return (
    <section id="courses" className="w-full min-h-screen py-[200px] max-lg:py-[70px] max-md:py-[60px] max-sm:py-[80px] bg-[#101010] flex justify-center items-center flex-col overflow-hidden">
      <div className="w-[90%] max-sm:w-[95%] relative flex flex-col gap-[64px] max-sm:gap-[32px] justify-center items-center">
        <h2 className="font-sans text-white text-[10vw] max-lg:text-[12vw] font-black leading-[100%] tracking-normal break-words w-full">Our <span className="font-display italic">Programs</span></h2>
        ...
        >
          {COURSES.map((c) => (
            ...
            >
              ...
              <img loading="lazy" decoding="async" src={c.img} alt={c.title} className="absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-x-0 bottom-0 h-[60%] bg-gradient-to-t from-black/90 via-black/40 to-transparent" />
              <h3 className="font-sans text-white text-[20px] font-bold relative z-10">{c.title}</h3>
              <p className="text-white/70 text-[13px] relative z-10 mt-1">{c.duration}</p>
              <p className="text-white/80 text-[14px] relative z-10 mt-1">{c.desc}</p>
              <a href={waHref(c.title)} target="_blank" rel="noopener" className="text-nifs-green text-[13px] font-semibold relative z-10 mt-3 inline-block">
        ...
        <div id="courseCarousel" className="w-full max-w-[56rem] mx-auto max-md:hidden" style={{ perspective: "1000px" }}>
          <div className="grid grid-cols-2 gap-[5rem] items-center">
            <div ref={stackRef} className="relative w-full h-[24rem]">
              {COURSES.map((c, i) => (
                ...
                <img
                  ...
                  style={{ boxShadow: "0 10px 30px rgba(0,0,0,0.4)", transition: "all 0.8s cubic-bezier(.4,2,.3,1)" }}
                />
              ))}
            </div>
            ...
            <div className="flex flex-col justify-between">
              <div>
                <h3 className="font-sans font-bold text-[28px] text-white leading-tight">{course.title}</h3>
                <p className="font-sans text-white/50 text-[15px] mt-2">{course.duration}</p>
                <p key={active} className="font-sans text-white/70 text-[18px] mt-8 leading-[1.75]">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  className="inline-flex items-center gap-2 mt-6 text-nifs-green font-sans font-semibold text-[15px] hover:underline"
                >
