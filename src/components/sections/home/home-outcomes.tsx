const ROLES = [
  {
    ...
    hover: "hover:bg-nifs-red hover:border-nifs-red",
  },
  {
    label: "Industrial Safety Supervisor",
    hover: "hover:bg-nifs-green hover:border-nifs-green",
  },
  {
    label: "HSE Manager",
    hover: "hover:bg-nifs-orange hover:border-nifs-orange",
  },
  {
  ...
  {
    label: "Plant Safety Coordinator",
    hover: "hover:bg-nifs-red hover:border-nifs-red",
  },
  {
    label: "Environmental Compliance Analyst",
    hover: "hover:bg-nifs-green hover:border-nifs-green",
  },
];
  ...
  return (
    <section className="w-full py-[120px] max-lg:py-[70px] bg-black flex justify-center items-center flex-col overflow-hidden">
      <div className="w-[90%] max-sm:w-[95%] flex flex-col gap-12 items-center">
        <h2 className="font-sans text-white text-[6vw] max-lg:text-[8vw] font-black leading-none text-center break-words w-full">
          Where Our <span className="font-display italic">Graduates Work</span>
        </h2>
