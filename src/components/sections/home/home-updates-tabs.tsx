    ...
    <section className="w-full bg-[#0d0d0d] py-[90px] max-lg:py-[60px]">
      <div className="max-w-[1200px] mx-auto px-6 flex flex-col gap-10">
        <div className="flex flex-col gap-2">
          <span className="font-sans text-red-500 text-xs font-bold uppercase tracking-[4px]">
            Live Feed
          </span>
          <h2 className="font-sans text-white text-[2.8vw] max-lg:text-[5vw] max-sm:text-[26px] font-black leading-tight break-words w-full">
            NIFS <span className="font-display italic">Updates</span>
          </h2>
          <p className="font-sans text-slate-300 text-[14px]">
            Real-time announcements, events, and opportunities from NIFS
          </p>
        </div>
            ...
            {TABS.map((t) => (
              <button
                ...
                className={`flex items-center gap-3 px-5 py-3.5 rounded-[14px] text-left transition-all duration-300 font-sans font-bold text-[14px] whitespace-nowrap cursor-pointer ${
                  tab === t.name
                    ? "bg-nifs-red text-white shadow-lg"
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  },
                  {
                    day: "05",
                    mon: "Aug",
                    chip: "bg-nifs-orange/20",
                    num: "text-nifs-orange",
                  ...
                  >
                    ...
                    >
                      <span
                        className={`font-sans ${e.num} font-black text-[20px] leading-none`}
                      >
                        {e.day}
                      </span>
                      <span
                        className={`font-sans ${e.sub} text-[10px] uppercase font-bold`}
                      >
                        {e.mon}
                      </span>
                    </div>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between gap-2 flex-wrap">
                        ...
                        <span
                          className={`font-sans ${j.badgeCls} text-[11px] font-bold px-2.5 py-1 rounded-full`}
                        >
                          {j.badge}
                        </span>
                      </div>
