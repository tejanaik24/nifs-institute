    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border-2 border-[#25D366]/40 bg-[#25D366]/5 p-6 text-left">
        ...
        <a
          ...
          className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-[#25D366] py-3.5 text-sm font-bold text-white shadow-md shadow-[#25D366]/25 hover:bg-[#20bd5a] transition-all"
        >
