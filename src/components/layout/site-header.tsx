      ...
      >
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 2xl:px-3.5 2xl:py-2 rounded-full bg-[#075E54] hover:bg-[#054239] text-white text-xs 2xl:text-sm font-bold transition-all duration-200 shadow-md shadow-[#075E54]/25"
          >
