...
export const metadata: Metadata = {
  ...
  description:
    "Join Nangal's top-rated Fire & Safety Officer training institute. NSDC approved 1-Year Diploma (DFS, ADIS), live practical training yard drills, and 100% placement support in Haryana & Punjab.",
  alternates: { canonical: "/centers/nangal/" },
  openGraph: {
    title: "Fire & Safety Officer Course in Nangal | NIFS Institute",
    description:
      "Govt-approved ADIS, Diploma in Fire & Safety, and EHS programs in Nangal, Haryana & Punjab. Live practical training and 100% placement support.",
    url: PAGE_URL,
    siteName: "NIFS India",
    locale: "en_IN",
    type: "website",
