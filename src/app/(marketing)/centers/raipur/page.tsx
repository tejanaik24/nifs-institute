...
import { RaipurPageView } from "./raipur-page-view";

const PAGE_URL = "https://nifsindia.net/centers/raipur/";
...
export const RAIPUR_FAQS = [
  {
    question: "Where is the NIFS center located in Raipur?",
    answer:
      "NIFS Raipur campus is located at Shop No. 4 & 5, RIO Complex, Opposite Fruit Market, Lalpur, Raipur, Chhattisgarh – 492001. For instant batch details, fee structure, and counseling, call +91-7509-333-401 or +91 83743 40999.",
  },
  {
  ...
  {
    question: "What is the minimum qualification required to join NIFS in Raipur?",
    answer:
...
export const metadata: Metadata = {
  title: "Fire and Safety Course in Raipur | Govt Approved NIFS Campus (4.9★)",
  description:
    "Join Raipur's top-rated Fire & Safety Officer training institute. 4.9★ on Google with verified alumni ratings. NSDC approved 1-Year Diploma (DFS, ADIS), live practical training yard drills, and 100% placement support in Chhattisgarh.",
  alternates: { canonical: "/centers/raipur/" },
  openGraph: {
    title: "Fire & Safety Officer Course in Raipur | NIFS Institute",
    description:
      "Govt-approved ADIS, Diploma in Fire & Safety, and EHS programs in Raipur, Chhattisgarh. 4.9★ Google Rating, live practical training, and 100% placement support.",
    url: PAGE_URL,
    siteName: "NIFS India",
    locale: "en_IN",
    type: "website",
...
export default function RaipurCenterPage() {
  return (
    <>
      <BreadcrumbSchema
        items={[
            ...
            "@graph": [
              {
                ...
                name: "National Institute of Fire and Safety (NIFS) — Raipur Center",
                alternateName: [
                  "NIFS Raipur",
                  "National Institute of Fire and Safety Raipur",
                ],
                url: PAGE_URL,
                telephone: "+917509333401",
                priceRange: "₹₹",
                image: "https://nifsindia.net/images/nifs-crest.png",
                address: {
                  "@type": "PostalAddress",
                  streetAddress: "Shop No. 4 & 5, RIO Complex, Opposite Fruit Market, Lalpur, Raipur, Chhattisgarh – 492001",
                ...
                review: [
                  {
                    ...
                    reviewBody:
                      "Completed my safety diploma from NIFS Raipur center. The practical firefighting drills gave huge real-world exposure. Placed as Safety Officer.",
                    reviewRating: {
                      "@type": "Rating",
                      ratingValue: "5",
                      bestRating: "5",
      ...
      <FAQSchema faqs={RAIPUR_FAQS} />

      <RaipurPageView courses={featuredCourses} faqs={RAIPUR_FAQS} />
    </>
  );
}
