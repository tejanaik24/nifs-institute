...
export const metadata: Metadata = {
  title: "Fire and Safety Course in Hamirpur | Govt Approved NIFS Campus",
  description:
    "Join Hamirpur's top-rated Fire & Safety Officer training institute. NSDC approved 1-Year Diploma (DFS, ADIS), live practical training yard drills, and 100% placement support in Himachal Pradesh.",
  alternates: { canonical: "/centers/hamirpur/" },
  openGraph: {
    title: "Fire & Safety Officer Course in Hamirpur | NIFS Institute",
    description:
      "Govt-approved ADIS, Diploma in Fire & Safety, and EHS programs in Hamirpur, Himachal Pradesh. Live practical training and 100% placement support.",
    url: PAGE_URL,
    siteName: "NIFS India",
    locale: "en_IN",
    type: "website",
