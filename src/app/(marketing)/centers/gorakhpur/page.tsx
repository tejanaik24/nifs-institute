...
export const metadata: Metadata = {
  title: "Fire and Safety Course in Gorakhpur | Govt Approved NIFS Campus",
  description:
    "Join Gorakhpur's top-rated Fire & Safety Officer training institute. NSDC approved 1-Year Diploma (DFS, ADIS), live practical training yard drills, and 100% placement support in Uttar Pradesh.",
  alternates: { canonical: "/centers/gorakhpur/" },
  openGraph: {
    title: "Fire & Safety Officer Course in Gorakhpur | NIFS Institute",
    description:
      "Govt-approved ADIS, Diploma in Fire & Safety, and EHS programs in Gorakhpur, Uttar Pradesh. Live practical training and 100% placement support.",
    url: PAGE_URL,
    siteName: "NIFS India",
    locale: "en_IN",
    type: "website",
