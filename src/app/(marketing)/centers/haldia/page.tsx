...
export const metadata: Metadata = {
  title: "Fire and Safety Course in Haldia | Govt Approved NIFS Campus",
  description:
    "Join Haldia's top-rated Fire & Safety Officer training institute. NSDC approved 1-Year Diploma (DFS, ADIS), live practical training yard drills, and 100% placement support in West Bengal.",
  alternates: { canonical: "/centers/haldia/" },
  openGraph: {
    title: "Fire & Safety Officer Course in Haldia | NIFS Institute",
    description:
      "Govt-approved ADIS, Diploma in Fire & Safety, and EHS programs in Haldia, West Bengal. Live practical training and 100% placement support.",
    url: PAGE_URL,
    siteName: "NIFS India",
    locale: "en_IN",
    type: "website",
