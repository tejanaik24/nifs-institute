...
export const metadata: Metadata = {
  title: "Fire and Safety Course in Kanpur | Govt Approved NIFS Campus (4.9★)",
  description:
    "Join Kanpur's top-rated Fire & Safety Officer training institute. 4.9★ on Google with verified alumni ratings. NSDC approved 1-Year Diploma (DFS, ADIS), live practical training yard drills, and 100% placement support in Uttar Pradesh.",
  alternates: { canonical: "/centers/kanpur/" },
  openGraph: {
    title: "Fire & Safety Officer Course in Kanpur | NIFS Institute",
    description:
      "Govt-approved ADIS, Diploma in Fire & Safety, and EHS programs in Kanpur, Uttar Pradesh. 4.9★ Google Rating, live practical training, and 100% placement support.",
    url: PAGE_URL,
    siteName: "NIFS India",
    locale: "en_IN",
    type: "website",
                ...
                review: [
                  {
                    ...
                    reviewBody:
                      "Completed my safety diploma from NIFS Kanpur center. The practical firefighting drills gave huge real-world exposure. Placed as Safety Officer.",
                    reviewRating: {
                      "@type": "Rating",
                      ratingValue: "5",
                      bestRating: "5",
