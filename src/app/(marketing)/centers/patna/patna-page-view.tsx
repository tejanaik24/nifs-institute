...
const LOCAL_PHONE = "+91-9204-615-085";
const LOCAL_TEL = "tel:+919204615085";
const WHATSAPP_URL =
  "https://wa.me/918374340999?text=" +
  encodeURIComponent(
    "Hi NIFS, I am interested in Fire and Safety courses at the Patna center. Please share fee structure and batch details.",
  );
const GOOGLE_MAPS_NAV_URL =
  "https://www.google.com/maps/dir/?api=1&destination=" +
  encodeURIComponent("NIFS Fire and Safety Patna C/o Wasisth Educational and Charitable Trust, 3rd Floor, Room No. 35, Ashiyana Galaxy, Exhibition Road, Near Gandhi Maidan, Patna – 01, Bihar");
const GOOGLE_REVIEW_URL = "https://g.page/r/nifs-patna/review";
const CENTER_ADDRESS = "C/o Wasisth Educational and Charitable Trust, 3rd Floor, Room No. 35, Ashiyana Galaxy, Exhibition Road, Near Gandhi Maidan, Patna – 01, Bihar";
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
                ...
                >
                  ...
                  <span>Connect with Patna Desk</span>
                </a>
                <a
                  href={LOCAL_TEL}
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-7 sm:p-8 shadow-2xl relative overflow-hidden space-y-6">
                <div className="space-y-2">
                  <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-bold">
                    ...
                    <span>2026 Admissions Open in Patna</span>
                  </div>
      ...
      <section className="border-b border-slate-200/80 bg-slate-50/50 py-10 overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 mb-6 text-center">
          <p className="text-xs font-bold uppercase tracking-widest text-slate-500">
            Top Hiring Partners for Patna Safety Officers
          </p>
        </div>
      ...
      <section className="border-t border-slate-200/80 bg-slate-50/50 py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="text-center max-w-2xl mx-auto space-y-3 mb-14">
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight text-slate-900">
              Recent Placements from NIFS Patna
            </h2>
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600">
                  ...
                  projections in Patna vs. Gulf countries.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-6 space-y-2 shadow-md">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[11px] font-bold text-primary bg-primary/10 px-2.5 py-0.5 rounded-full">
                    Bihar & Gulf Industrial Corridor
                  </span>
                </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          <div className="lg:col-span-5 flex flex-col justify-between rounded-3xl border border-slate-200 bg-white p-8 shadow-xl space-y-6">
              ...
              <div className="space-y-3">
                <div className="rounded-2xl border border-slate-200 bg-slate-50/50 p-4 text-xs space-y-1.5">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    &ldquo;Best practical training in Patna. Live fire drills gave huge confidence. Selected as Safety Officer.&rdquo;
                  </p>
                </div>
            ...
            >
              <span>Message Patna Counseling Desk</span>
            </a>
          </div>
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between">
                <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest text-primary">
                  ...
                  <span>Patna Regional Campus</span>
                </div>
              ...
              <div className="rounded-2xl bg-slate-50 p-4 border border-slate-200 flex items-center justify-between text-xs font-semibold">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-slate-900">
                    Gandhi Maidan / Central Bus Terminal
                  </span>
                </div>
      ...
      <section className="border-t border-slate-200 bg-slate-900 text-white py-16">
        <div className="mx-auto max-w-5xl px-6 text-center space-y-6">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight text-white">
            Start Your Safety Career in Patna Today
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            >
              <span>Chat with Patna Counselor</span>
            </a>
            <a
              href={LOCAL_TEL}
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16 lg:px-10">
        <div className="rounded-2xl border border-slate-200 bg-slate-50/50 px-6 py-5 text-center">
          ...
          <p className="text-sm text-slate-600">
            ...
            <span className="font-semibold text-slate-900">Muzaffarpur</span>{" "}
            at our Patna center.
          </p>
        </div>
      </section>
