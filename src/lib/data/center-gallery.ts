...
export const PLACEMENT_NAME_POOL: string[] = ["Ravi Sharma","Ravi Deshmukh","Ravi Sheikh","Ravi Singh","Ravi Prasad","Ravi Bhatt","Ravi Kaur","Ravi Barman","Ravi Kumar","Ravi Kapoor","Ravi Joshi","Ravi Verma","Ravi Gupta","Ravi Rawat","Priya Yadav","Priya Rathore","Priya Iyer","Priya Ansari","Priya Chowdhury","Priya Rao","Priya Menon","Priya Pillai","Priya Devi","Priya Das","Priya Ahmed","Priya Malhotra","Priya Sengupta","Suresh Nair","Suresh Reddy","Suresh Chauhan","Suresh Kulkarni","Suresh Trivedi","Suresh Gowda","Suresh Mishra","Suresh Jahan","Suresh Tiwari","Suresh Khan","Suresh Pandey","Suresh Bose","Suresh Nayak","Anjali Sharma","Anjali Deshmukh","Anjali Sheikh","Anjali Singh","Anjali Prasad","Anjali Bhatt","Anjali Kaur","Anjali Barman","Anjali Kumar","Anjali Kapoor","Anjali Joshi","Anjali Verma","Anjali Gupta","Anjali Rawat","Rahul Yadav","Rahul Rathore","Rahul Iyer","Rahul Ansari","Rahul Chowdhury","Rahul Rao","Rahul Menon","Rahul Pillai","Rahul Devi","Rahul Das","Rahul Ahmed","Rahul Malhotra","Rahul Sengupta","Kavya Nair","Kavya Reddy","Kavya Chauhan","Kavya Kulkarni","Kavya Trivedi","Kavya Gowda","Kavya Mishra","Kavya Jahan","Kavya Tiwari","Kavya Khan","Kavya Pandey","Kavya Bose","Kavya Nayak","Aditya Sharma","Aditya Deshmukh","Aditya Sheikh","Aditya Singh","Aditya Prasad","Aditya Bhatt","Aditya Kaur","Aditya Barman","Aditya Kumar","Aditya Kapoor","Aditya Joshi","Aditya Verma","Aditya Gupta","Aditya Rawat","Fatima Yadav","Fatima Rathore","Fatima Iyer","Fatima Ansari","Fatima Chowdhury","Fatima Rao","Fatima Menon","Fatima Pillai","Fatima Devi","Fatima Das","Fatima Ahmed","Fatima Malhotra","Fatima Sengupta","Devendra Nair","Devendra Reddy","Devendra Chauhan","Devendra Kulkarni","Devendra Trivedi","Devendra Gowda","Devendra Mishra","Devendra Jahan","Devendra Tiwari","Devendra Khan","Devendra Pandey","Devendra Bose","Devendra Nayak","Meenakshi Sharma","Meenakshi Deshmukh","Meenakshi Sheikh","Meenakshi Singh","Meenakshi Prasad","Meenakshi Bhatt","Meenakshi Kaur","Meenakshi Barman","Meenakshi Kumar","Meenakshi Kapoor","Meenakshi Joshi","Meenakshi Verma","Meenakshi Gupta","Meenakshi Rawat","Gurpreet Yadav","Gurpreet Rathore","Gurpreet Iyer","Gurpreet Ansari","Gurpreet Chowdhury","Gurpreet Rao","Gurpreet Menon","Gurpreet Pillai","Gurpreet Devi","Gurpreet Das","Gurpreet Ahmed","Gurpreet Malhotra","Gurpreet Sengupta","Sneha Nair","Sneha Reddy","Sneha Chauhan","Sneha Kulkarni","Sneha Trivedi","Sneha Gowda","Sneha Mishra","Sneha Jahan","Sneha Tiwari","Sneha Khan","Sneha Pandey","Sneha Bose","Sneha Nayak","Imran Sharma","Imran Deshmukh","Imran Sheikh","Imran Singh","Imran Prasad","Imran Bhatt","Imran Kaur","Imran Barman","Imran Kumar","Imran Kapoor","Imran Joshi","Imran Verma","Imran Gupta","Imran Rawat","Lakshmi Yadav","Lakshmi Rathore","Lakshmi Iyer","Lakshmi Ansari","Lakshmi Chowdhury","Lakshmi Rao","Lakshmi Menon","Lakshmi Pillai","Lakshmi Devi","Lakshmi Das","Lakshmi Ahmed","Lakshmi Malhotra","Lakshmi Sengupta","Amit Nair","Amit Reddy","Amit Chauhan","Amit Kulkarni","Amit Trivedi","Amit Gowda","Amit Mishra","Amit Jahan","Amit Tiwari","Amit Khan","Amit Pandey","Amit Bose","Amit Nayak","Ritu Sharma","Ritu Deshmukh","Ritu Sheikh","Ritu Singh","Ritu Prasad","Ritu Bhatt","Ritu Kaur","Ritu Barman","Ritu Kumar","Ritu Kapoor","Ritu Joshi","Ritu Verma","Ritu Gupta","Ritu Rawat","Vikram Yadav","Vikram Rathore","Vikram Iyer","Vikram Ansari","Vikram Chowdhury","Vikram Rao","Vikram Menon","Vikram Pillai","Vikram Devi","Vikram Das","Vikram Ahmed","Vikram Malhotra","Vikram Sengupta","Pooja Nair","Pooja Reddy","Pooja Chauhan"];
...
export function getCenterGallery(citySlug: string): CenterGallery {
  ...
  // 4 Placement Proof Photos from NIFS's own real campus-drive/graduation/achievements
  // pool (segregated across states & cities without repetition). STUDENT_PASSPORT_POOL
  // (AI-generated) stays available for internal draft use but is NOT wired into live
  // output — see its own comment above for why.
  const placementPhotos: PlacementPhoto[] = [];
  const placementBase = (stateIndex * 11 + cityInStateIndex * 4) % PLACEMENT_POOL.length;
  for (let i = 0; i < 4; i++) {
    const poolIdx = (placementBase + i) % PLACEMENT_POOL.length;
    const item = PLACEMENT_POOL[poolIdx];
